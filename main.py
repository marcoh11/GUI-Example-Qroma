...
lblTiempoOt.grid(row=1,column=0,sticky=W)
lblDescripcionOT=tk.Label(formOt,text="Descripción: ")
lblDescripcionOT.config(bg="#0070BA",fg="#FFFFFF")
lblDescripcionOT.grid(row=2,column=0,sticky=NSEW)
enTiempoOt=tk.Entry(formOt)
enTiempoOt.grid(row=1,column=1,sticky=E)
enDescripcionOT=tk.Entry(formOt)
enDescripcionOT.grid(row=2,column=1,sticky=E,rowspan=2)
